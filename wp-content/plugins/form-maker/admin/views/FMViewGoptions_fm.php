    ...
    <form class="wrap" method="post" action="admin.php?page=goptions_fm">
      ...
      <table style="clear:both;">
        ...
        <tr>
          ...
          <td>
            <a href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend&keyType=CLIENT_SIDE&reusekey=true" target="_blank">Get
              map API key</a>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding: 6px 0 0 3px">
            ...
            <div style="width:250px; display: inline-block; padding: 0 5px; color:red">Check this box only if you are
              getting JavaScript errors while trying to submit the form.
            </div>
          </td>
        </tr>
        <tr>
          <td style="vertical-align: top; width: 200px;">
            <label for="fm_advanced_layout">Enable Advanced Layout:</label>
          </td>
          <td style="padding: 6px 0 0 3px">
            <input style="vertical-align:top;" type="checkbox" id="fm_advanced_layout" name="fm_advanced_layout" <?php if ($fm_advanced_layout) echo "checked ='checked'" ?>/>
            <div style="width:250px; display: inline-block; padding: 0 5px; color:red">For advanced users only.</div>
          </td>
        </tr>
        </tbody>
      </table>
