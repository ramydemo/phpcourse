	...
	if(product_name || product_price){
		...
		if(field_type =="checkbox" || field_type =="radio"){	
			...
			var el_choices_remove = document.createElement('img');
				...
				el_choices_remove.setAttribute("src", plugin_url + '/images/delete.png?ver=<?php echo WD_FM_VERSION; ?>');
			...
			var el_choices_handle = document.createElement('img');
				...
				el_choices_handle.setAttribute("src", plugin_url + '/images/move_cursor.png?ver=<?php echo WD_FM_VERSION; ?>');		
...
<?php if($table_struct): ?>
	<div class="cols">
		...
		<div class="select-db-op where"><img src="<?php echo WD_FM_URL . '/images/add_condition.png?ver='. WD_FM_VERSION.''; ?>" title="ADD" class="add_cond"/>WHERE</div>
