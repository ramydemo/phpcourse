...
Whereas Stripe form can be configured on this contact form plugin with its [Stripe Integration add-on](https://web-dorado.com/products/wordpress-form/add-ons/stripe.html).
